...
public class MediaClientProperties {
    ...
    private String thumbnailFolder = "Dot-Blog/Blog_Thumbnails";

    public String getBaseUrl() { return baseUrl; }
    public void setBaseUrl(String baseUrl) { this.baseUrl = baseUrl; }
    public String getThumbnailFolder() { return thumbnailFolder; }
    public void setThumbnailFolder(String thumbnailFolder) { this.thumbnailFolder = thumbnailFolder; }
}
